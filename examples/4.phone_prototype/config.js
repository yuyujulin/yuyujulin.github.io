let DefaultServerConfig = {
    domain: 'southtestwebrtc.aicccloud.com',
    addresses: ['wss://southtestwebrtc.aicccloud.com:65061'],
    iceServers: [],
    version: '9-May-2022'
}
...
let DefaultPhoneConfig = {
    ...
    pingInterval: 20,          // Keep alive ping interval,  0 value means don't send pings. (seconds)
    ...
    pongReport: 1,           // if 0 not print, otherwise each N pongs print min and max pong delay 
    pongDist: true,          // Print to console log also pong delay distribution.    
    ...
    modes: {
        ...
        chrome_rtp_timeout_fix: 23,        // Workaround of https://bugs.chromium.org/p/chromium/issues/detail?id=982793
