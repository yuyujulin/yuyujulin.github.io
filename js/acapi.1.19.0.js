...
class AudioCodesUA {
    ...
    _onPongTimeout(pingMs) {
        ...
        if (this.wsPongTimeout) {
            ...
            this.wsWebSocketInterface._onClose.call(this.wsWebSocketInterface, { wasClean: false, code: 1001, reason: 'Going Away' });
        } else {
    ...
    _startWsKeepAlive() {
        let transport = this.jssipUA._transport;
